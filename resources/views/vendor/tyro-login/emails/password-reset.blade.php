                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                ...
                                <tr>
                                    <td style="padding-bottom: 10px;">
                                        <h1 class="mobile-title" style="margin: 0; font-size: 26px; font-weight: 600; letter-spacing: -0.025em; color: #111827;">Reset your password</h1>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding-bottom: 28px;">
                                        <p style="margin: 0; font-size: 18px; color: #6b7280; line-height: 1.6;">
                                            Hi {{ $name }}, we received a request to reset the password for your account. Click the button below to choose a new password.
                                        </p>
                                    </td>
                                </tr>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                <td align="center" style="border-radius: 8px; background-color: #111827;">
                                                    <a href="{{ $resetUrl }}" target="_blank" class="mobile-button" style="display: inline-block; padding: 14px 28px; font-size: 18px; font-weight: 500; color: #ffffff; text-decoration: none; border-radius: 8px;">
                                                        Reset Password &nbsp;→
                                                    </a>
                                                </td>
                                            </tr>
                    ...
                    <tr>
                        <td align="center" style="padding: 28px 36px; background-color: #f9fafb; border-radius: 0 0 12px 12px;">
                            <p style="margin: 0; font-size: 15px; color: #9ca3af;">
                                If you didn't request a password reset, please ignore this email. This link expires in {{ $expiresIn }} minutes.
                            </p>
                        </td>
                    </tr>
